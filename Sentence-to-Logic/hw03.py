...
def logic01_03():
    ...
    ################# Write Your Code Here #########################
    return Or(And(Not(Day),Night),And(Not(Night),Day))
    ################################################################
...
def suspect():
    ...
    #5
    formulas.append(Exists('$y',Forall('$x',And(Implies(TellTruth('$x'),Equals('$x','$y')),Implies(Equals('$x','$y'),TellTruth('$x'))))))
    #6
    formulas.append(Exists('$y', Forall('$x',And(Implies(CrashedServer('$x'), Equals('$x', '$y')),Implies(Equals('$x', '$y'),CrashedServer('$x'))))))
...
def number_theorem():
    ...
    #2
    formulas.append(Forall('$x',Or(And(Not(Even('$x')),Odd('$x')),And(Not(Odd('$x')),Even('$x')))))
    #3
